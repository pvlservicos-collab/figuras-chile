...
export default function Obrigado() {
  const handleShare = () => {
    ...
    const text = "¡Increíble! Transformé a mi hijo en figurita del Mundial 2026. ¡Crea la tuya también:";
    ...
    <main className="flex flex-col items-center min-h-screen bg-white px-5 py-8 overflow-hidden">
      ...
      <div className="w-full max-w-md flex flex-col items-center animate-slide-up">
        ...
        >
          ...
          menos de <strong className="text-copa-green">30 minutos</strong>.
        </p>
